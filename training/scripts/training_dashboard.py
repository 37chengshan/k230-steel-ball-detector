#!/usr/bin/env python3
"""Live, dependency-free local dashboard for the two training runs."""
...
def read_run(name: str, directory: Path) -> dict:
    ...
    if not results.is_file():
        return {"name": name, "epochs": [], "map50": [], "precision": [], "recall": [], "terminal": "等待训练进程写入第一轮数据…", "state": "启动中", "updated": "—"}
